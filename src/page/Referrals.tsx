...
const Referrals: React.FC = () => {
  ...
  const getReferralDetails = async () => {
    try {
      ...
      setBonusRequirement(data.bonusRequirment);
    } catch (error) {
      console.error("There was a problem with the fetch operation:", error);
    }
  };
        ...
        <div className="content-wrapper px-4">
              ...
              <div className="text-start">
                ...
                <div className="flex justify-center items-center px-2">
                  ...
                  <span className="text-2xl ml-1">
                    +{bonusRequirment.amount}
                  </span>
                  {bonusRequirment &&
                    (bonusRequirment.amount === 1000 ? (
                      <span className="text-[12px] ml-2">
                        for you and your friend
                      </span>
                    ) : (
                      <span className="text-[12px] ml-2">
                        for you and <br /> your friends receive +1000 each
                      </span>
                    ))}
                </div>
              </div>
          ...
          {referralDetails && referralDetails.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full w-full">
              ...
              <div className="mt-auto text-2xl text-[#D99748] text-center">
                Tap the button below to copy and
                <br /> share the link with your friends!
              </div>
            </div>
